...
public class MoMoController {
	...
	private String redirectUrl = "http://localhost:8081/customer/shoppingCart";
	private String ipnUrl = "http://localhost:8081/shoppingCart";
	private String extraData = "";

	@GetMapping("/momo")
	public RedirectView momo(String fullName, String phoneNumber, String address,String price, HttpServletResponse httpServletResponse) throws IOException {
...
//       String extraData = postData.get("extraData");
		...
		String rawHash = "accessKey=" + postData.get("accessKey") + "&amount=" + postData.get("amount") + "&extraData="
				+ extraData + "&ipnUrl=" + postData.get("ipnUrl") + "&orderId=" + postData.get("orderId")
				+ "&orderInfo=" + postData.get("orderInfo") + "&partnerCode=" + postData.get("partnerCode")
				+ "&redirectUrl=" + postData.get("redirectUrl") + "&requestId=" + requestId + "&requestType="
				+ requestType;
